...
export function SourcePreviewPanel() {
  ...
  return (
    <div className="fixed inset-0 bg-foreground/30 flex items-center justify-center z-[60] p-4" style={{ pointerEvents: 'auto' }} onClick={(e) => { e.stopPropagation(); closeModal(); }}>
